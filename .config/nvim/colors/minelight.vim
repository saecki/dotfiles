...
highlight DiffAdd       ctermbg=156   ctermfg=0
highlight DiffChange    ctermbg=183   ctermfg=0
highlight DiffRemove    ctermbg=203   ctermfg=0
highlight DiffDelete    ctermbg=203   ctermfg=0
