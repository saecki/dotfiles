    ...
    nvim_tree.setup {
        ...
        on_attach = function(buf)
            wk.register({
                ...
                [">"]              = { api.node.navigate.sibling.next, "Previous sibling" },
                ...
                ["[d"]             = { api.node.navigate.diagnostics.prev, "Next diagnsotic" },
                ["]d"]             = { api.node.navigate.diagnostics.next, "Previous diagnsotic" },
                ["[g"]             = { api.node.navigate.git.prev, "Next git item" },
                ["]g"]             = { api.node.navigate.git.next, "Previous git item" },
