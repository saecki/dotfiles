...
let g:airline#themes#minelight#palette.normal_modified = { 'airline_c': [ '#000000', '#000000', 3  , 255 ] }

" Insert mode
let s:I1 = [ '#000000', '#000000', 2  , 252 ]
let s:I2 = s:N2
let s:I3 = s:N3
let g:airline#themes#minelight#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
let g:airline#themes#minelight#palette.insert_modified = { 'airline_c': [ '#000000', '#000000', 2  , 255 ] }
...
" Visual mode
let s:V1 = [ '#000000', '#000000', 5  , 252 ]
let s:V2 = s:N2
let s:V3 = s:N3
let g:airline#themes#minelight#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
let g:airline#themes#minelight#palette.visual_modified = { 'airline_c': [ '#000000', '#000000', 5  , 255 ] }

" Command mode
let s:C1 = [ '#000000', '#000000', 4  , 252 ]
let s:C2 = s:N2
let s:C3 = s:N3
let g:airline#themes#minelight#palette.commandline = airline#themes#generate_color_map(s:C1, s:C2, s:C3)
let g:airline#themes#minelight#palette.commandline_modified = { 'airline_c': [ '#000000', '#000000', 4  , 255 ] }
...
let g:airline#themes#minelight#palette.inactive_modified = { 'airline_c': [ '#000000', '#000000', 15 , 255 ] }
