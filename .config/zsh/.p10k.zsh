# Generated by Powerlevel10k configuration wizard on 2020-10-10 at 03:55 CEST.
...
# unicode, light, 24h time, angled separators, sharp heads, flat tails, 2 lines, solid,
# left frame, compact, many icons, concise, transient_prompt, instant_prompt=off.
